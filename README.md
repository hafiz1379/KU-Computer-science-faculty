...
# 📖 Kabul University (Computer Science faculty) <a name="about-project"></a>

> This is my Kabul University (Computer Science faculty) project! created it by using HTML, CSS and JavaScript.
